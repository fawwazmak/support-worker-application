  ...
  return (
    <div className='p-4 overflow-hidden'>
      ...
      <div className='flex md:flex-row flex-col md:justify-between md:gap-y-0 gap-y-3 my-3'>
        <input type="search" name="searchProfile" id="searchProfile" placeholder='Search Profile' className='block w-full md:w-3/5 bg-blue-100 outline-none rounded-3xl p-3' />
      ...
      <table className='w-full text-left mt-16 border rounded-[5px] md:overflow-x-hidden overflow-x-scroll'>
        ...
        <tbody className='font-semibold'>
          <tr>
            ...
            <td className='flex md:gap-5 gap-2 px-3 py-2'>
              <div className='border border-dotted rounded-[5px] cursor-pointer p-2 h-8 w-8 flex items-center justify-center text-red-500'><FontAwesomeIcon icon={faTrashCan} /></div>
              <div className='border border-dotted rounded-[5px] cursor-pointer p-2 h-8 w-8 flex items-center justify-center text-blue-500'><FontAwesomeIcon icon={faPen} /></div>
            </td>
          </tr>
        </tbody>
      </table>
